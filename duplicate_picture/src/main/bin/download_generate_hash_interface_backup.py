...
def log_job():
    ...
    access_str = ACCESS_LOGS_PATH + '/access' + log_subffix
    print(access_str)
...
access_handler = logging.handlers.TimedRotatingFileHandler(os.path.join(ACCESS_LOGS_PATH, 'access'), when='midnight')
