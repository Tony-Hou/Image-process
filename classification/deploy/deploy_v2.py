...
def demo():
    if request.method == 'POST':
        ...
        image = cv2.resize(image, (image_height, image_width), cv2.INTER_LINEAR)
        images.append(image)
        ...
        print(pred)
        out={"bathroom":str(result[0][0]),"bedroom":str(result[0][1]),"floorplan":str(result[0][2]),"kitchen":str(result[0][3]),
    ...
    <html lang="en">
    <head>
      <title>Running real estate Demo</title>
    </head>
    <body>
    <div class="site-wrapper">
        <div class="cover-container">
            <nav id="main">
                <a href="http://localhost:6007/demo" >HOME</a>
            </nav>
          ...
          <hr />
            <div class="container">
              <div style="margin-top:5%">
		            <h1 style="color:black">Real estate  Classification Demo</h1>
...
if __name__ == '__main__':
    app.run(host="10.200.0.174", port=int("6007"), debug=True, use_reloader=False)
